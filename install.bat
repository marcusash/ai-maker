...
set "BASE_URL=https://github.com/marcusash/ai-maker/releases/download/v3.0.9"
...
if not defined PS (
    ...
    echo.
    echo        curl.exe -sSL -o %%TEMP%%\install.bat https://github.com/marcusash/ai-maker/releases/download/v3.0.9/install.bat ^&^& %%TEMP%%\install.bat
    echo.
    echo   This is normal — install resumes from where it left off.
    echo   ============================================================
    echo.
