...
#                    Filed as: marcusash_microsoft/ai-maker#7
# R2 (Red upgrade):  #1 #2 #3 #6 #9 #10 #12.1 required
#                    #5 deferred to Phase 2 (no Describe block shipped — same gap as B2)
#                    Filed as: marcusash_microsoft/ai-maker#8
